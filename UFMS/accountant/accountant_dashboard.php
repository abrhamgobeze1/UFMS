...
// Query to fetch total employees with 'Accountant' role
$sql = "SELECT COUNT(*) AS total_admin FROM employee WHERE role = 'Accountant'";
$result = $conn->query($sql);
if ($result !== false && $result->num_rows > 0) {
...
<head>
    ...
    <title>Accountant Dashboard - Online Dormitory Placement System</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">Accountant Dashboard</h2>
        <h4 class="text-center mb-4">Managing employees assigned for: <?php echo htmlspecialchars($assigned_for); ?></h4>
        <div class="row  mb-4">
            <div class="col-auto">
                <h4> Your Accountant Name: <?php echo htmlspecialchars($name); ?></h4>
