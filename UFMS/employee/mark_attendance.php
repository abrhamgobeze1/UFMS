...
if (!isset($_SESSION["user_type"]) || 
   !in_array($_SESSION["user_type"], ["Teacher", "Cleaner", "Dormitory Proctors", "Libraries", "Lab Assistants", "Security", "Cafe Workers"])) {
    // All specified user types will have access to this page
