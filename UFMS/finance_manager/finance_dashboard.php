...
// Query to fetch total employees with 'Finance Managers' role
$sql = "SELECT COUNT(*) AS total_admin FROM employee WHERE role = 'Finance Managers'";
$result = $conn->query($sql);
if ($result !== false && $result->num_rows > 0) {
...
<head>
    ...
    <title>Finance Managers Dashboard - Online Dormitory Placement System</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">Finance Managers Dashboard</h2>
        <h4 class="text-center mb-4">Managing employees assigned for: <?php echo htmlspecialchars($assigned_for); ?></h4>
        <div class="row  mb-4">
            <div class="col-auto">
                <h4> Your Finance Managers Name: <?php echo htmlspecialchars($name); ?></h4>
