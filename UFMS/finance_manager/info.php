...
// Fetch Finance Managers's information from the session
$cashier_id = $_SESSION["user_id"];

// Query to fetch Finance Managers's information
...
<head>
    ...
    <title>Finance Managers Information</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">Finance Managers Information</h2>
