...
$sql = "SELECT COUNT(*) AS total_accountant FROM employee WHERE role = 'Accountant' AND assigned_for = '$assigned_for'";
$result = $conn->query($sql);
if ($result !== false && $result->num_rows > 0) {
...
// Query to fetch total employees with 'HR Manager' role
$sql = "SELECT COUNT(*) AS total_admin FROM employee WHERE role = 'HR Manager'";
$result = $conn->query($sql);
if ($result !== false && $result->num_rows > 0) {
...
<head>
    ...
    <title>HR Manager Dashboard - Online Dormitory Placement System</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">HR Manager Dashboard</h2>
        <h4 class="text-center mb-4">Managing employees assigned for: <?php echo htmlspecialchars($assigned_for); ?></h4>
        <div class="row  mb-4">
            <div class="col-auto">
                <h4> Your HR Manager Name: <?php echo htmlspecialchars($name); ?></h4>
        ...
        <div class="row"> 
            ...
            <div class="col-md-4">
                <div class="card text-white bg-warning mb-3">
                    <div class="card-header">Total Accountants</div>
                    <div class="card-body">
