...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['add_employee'])) {
        ...
        $stmt->bind_param("sssssss", $name, $phone, $assigned_for, $hire_date, $salary, $username, $password);
        $stmt->execute();
...
<main class="container mt-5">
    <section class="dashboard card">
        <div class="card-header">
            <h2 class="mb-0">Manage Employees  Those Are    :   <span class="bg-info"> <?php echo htmlspecialchars($assigned_for); ?></span> </h2>
        </div>
        <div class="card-body">
                ...
                <?php foreach ($employees as $employee) : ?>
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <h6 class="card-title"> <strong> Username : </strong><?php echo $employee['username']; ?></h6>
                                <p class="card-text">Role: <?php echo $employee['role']; ?></p>
                                <p class="card-text">Username: <?php echo $employee['username']; ?></p>
                                <p class="card-text">Account Number: <?php echo $employee['account_number']; ?></p>
