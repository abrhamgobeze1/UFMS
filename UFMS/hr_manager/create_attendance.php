...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['create_attendance'])) {
    ...
    $sql = "INSERT INTO attendance (employee_id, date, created, status) VALUES (?, ?, 'Created', 'UnMarked')";
...
$attendance_sql = "SELECT a.attendance_id, e.name, a.date, a.created, a.status 
                   FROM attendance a 
