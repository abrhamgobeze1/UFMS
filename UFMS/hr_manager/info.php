...
// Check if the user is logged in as HR Managers, if not redirect to login page
if (!isset($_SESSION["user_type"]) || $_SESSION["user_type"] !== "HR Managers") {
    header("Location: ../login.php");
    exit;
}

// Fetch HR Managers's information from the session
$cashier_id = $_SESSION["user_id"];

// Query to fetch HR Managers's information
...
<head>
    ...
    <title>HR Managers Information</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="container my-5">
        <h2 class="text-center mb-4">HR Managers Information</h2>
